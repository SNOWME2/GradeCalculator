...
//BA.debugLineNum = 17;BA.debugLine="copyright.SetTopAndBottom(80%y,20%y)"[Layout/General script]
views.get("copyright").vw.setTop((int)((80d / 100 * height)));
views.get("copyright").vw.setHeight((int)((20d / 100 * height) - ((80d / 100 * height))));
//BA.debugLineNum = 18;BA.debugLine="copyright.SetLeftAndRight(30%x,65%x)"[Layout/General script]
views.get("copyright").vw.setLeft((int)((30d / 100 * width)));
views.get("copyright").vw.setWidth((int)((65d / 100 * width) - ((30d / 100 * width))));
//BA.debugLineNum = 20;BA.debugLine="ASFlowTabMenu1.SetTopAndBottom(89.5%y,100%y)"[Layout/General script]
